# 🗺️ Roadmap, Control de Módulos y Registro de Cambios
...
graph TD
    ...
    B --> B2["🖥️ Célula de Cabecera OLT (4 especialistas)"]
...
- **Sintaxis Oficial de Inter Integrada:**
  ...
  - **Ubicación en OLT:** Como generalmente no se envía en el correo, asigna inteligentemente *"Consultar en OLT vía Serial PON"*.
